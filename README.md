...
You may also be interested in [libocr's integration into the actual Chainlink node](https://github.com/OmniBTC/chainlink/tree/develop/core/services/offchainreporting).
